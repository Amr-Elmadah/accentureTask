package com.tasks.accenturetask.base.domain.exception

class AccentureException : Exception {
    ...
    fun setData(data: String): AccentureException {
        this.data = data
        return this
    }
    ...
    fun setStatusCode(statusCode: Int): AccentureException {
    ...
    fun setErrorCode(errorCode: Int): AccentureException {
